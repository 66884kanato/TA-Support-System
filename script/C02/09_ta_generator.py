...
#		print(logfile_line)
		...
		ta_unit_ByID[ta_file_data[2]] = '-'
# TAへの希望
		if(len(re.findall('教員やTAには、質問がある時のみ教えて欲しい',ta_file_line)) != 0):
			ta_unit_ByID[ta_file_data[2]] = '1'
		if(len(re.findall('教員やTAには、定期的に学習の進捗を確認して欲しい',ta_file_line)) != 0):
			ta_unit_ByID[ta_file_data[2]] = '2'
		if(len(re.findall('教員やTAには、内容がわかるまで十分に教えて欲しい',ta_file_line)) != 0):
			ta_unit_ByID[ta_file_data[2]] = '3'
