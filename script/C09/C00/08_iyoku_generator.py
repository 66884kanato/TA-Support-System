...
for iyoku_file_input_name in iyoku_files:
	...
	for iyoku_file_line in iyoku_file_name:
		...
		iyoku_file_line = iyoku_file_line.replace('この授業の試験範囲の内容に取り組みたい', '1')
		iyoku_file_line = iyoku_file_line.replace('余裕があればこの授業の高度な内容に取り組みたい', '2')
		iyoku_file_line = iyoku_file_line.replace('この授業に関連する高度な内容に取り組みたい', '3')

#		print(logfile_line)
		iyoku_file_data = iyoku_file_line[:-1].split(',')
		iyoku_unit_ByID[iyoku_file_data[2]] = iyoku_file_data[12]
